...
- Sigue desde esa ficha los `tech-design.md` que enlaza: ahí está el diseño de cada historia
...
- El catálogo de módulos reales está en `docs/03-modulos/_vision-general.md`; las fichas enlazan los `tech-design.md` de las historias en vez de duplicarlos
