...
> **Progreso**: 0/5 completadas · **Hito**: Hito A — Base segura y multiusuario
> _Generado automáticamente por `validar_kb.py`. No editar manualmente._

| Historia | Título | Estado | Responsable | Prioridad |
|----------|--------|--------|-------------|-----------|
| [MVP-101](./MVP-101--google-oidc-y-sesion-base/spec.md) | Acceso con Google OIDC y sesión base | 📝 borrador | @andres | critica |
| [MVP-102](./MVP-102--creacion-de-workspace-y-primer-acceso/spec.md) | Creación de Workspace y primer acceso guiado | 📝 borrador | @andres | critica |
| [MVP-103](./MVP-103--invitaciones-por-email-y-enlace/spec.md) | Invitaciones por email y enlace | 📝 borrador | @andres | alta |
