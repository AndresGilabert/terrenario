...
> **Progreso**: 0/6 completadas · **Hito**: Hito C — Registro operativo end-to-end
> _Generado automáticamente por `validar_kb.py`. No editar manualmente._

| Historia | Título | Estado | Responsable | Prioridad |
|----------|--------|--------|-------------|-----------|
| [MVP-301](./MVP-301--registro-y-edicion-de-actividades/spec.md) | Registro y edición de actividades | 📝 borrador | @andres | critica |
| [MVP-302](./MVP-302--guardado-de-tarea-libre-en-catalogo/spec.md) | Guardado de tarea libre en catálogo | 📝 borrador | @andres | media |
| [MVP-303](./MVP-303--registro-de-compras-operativas/spec.md) | Registro de compras operativas | 📝 borrador | @andres | alta |
