...
export const LegalPage: React.FC<{
  ...
  <div className="min-h-screen bg-[#fcf9f4]">
    ...
    <main className="max-w-3xl mx-auto px-5 py-10">
      ...
      {/* Aviso de estado del documento. No es decorativo: mientras queden marcadores sin rellenar,
          esta página no es publicable, y quien la lea tiene que saberlo. */}
      <div className="mt-6 p-4 rounded-2xl bg-[#fff6e5] border border-[#f0d9a8] text-sm text-[#8a5a00]">
        ...
        <p className="mt-1 text-xs leading-relaxed">
          Los datos del responsable del tratamiento aparecen como marcadores entre corchetes. Deben
          rellenarse y el texto revisarse por asesoría legal antes de exponer el servicio a usuarios
          reales.
        </p>
      </div>
...
/** Marcador de un dato que solo puede aportar el negocio. Se resalta para que no pase inadvertido. */
export const Placeholder: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <span className="px-1 py-0.5 rounded bg-[#fdf0d8] text-[#8a5a00] font-semibold">[{children}]</span>
);
